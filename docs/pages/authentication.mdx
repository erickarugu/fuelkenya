...
The `POST /api/v1/ingest/csv` endpoint is **admin-only** and requires a Bearer token. This endpoint is used to load new EPRA pricing cycles into the database and is not intended for public use.
