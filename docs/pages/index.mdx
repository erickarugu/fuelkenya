---
title: Overview
description: FuelKenya REST API — official EPRA pump prices across all towns in Kenya.
---
...
<Callout type="info">
  **Base URL** — `https://api.fuelkenya.com/api/v1`
...
The current API version is **v1**. All v1 endpoints are prefixed with `/api/v1`. Breaking changes will be released under a new version prefix; v1 will remain stable.
