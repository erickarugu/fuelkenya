...
description: FuelKenya API client examples in JavaScript and TypeScript.
---
...
```ts
const BASE_URL = "https://api.fuelkenya.com/api/v1";
...
const BASE = process.env.NEXT_PUBLIC_FUELKENYA_API_URL ?? "http://localhost:8000/api/v1";
