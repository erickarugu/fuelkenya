---
title: curl
description: curl examples for querying EPRA fuel prices in Kenya via the FuelKenya REST API — copy-paste ready commands for Super Petrol, Diesel, and Kerosene data.
---
